...
GLfloat xt2=0.0, yt2=0.0, zt2=0.0, xw2=0.0; /*x y z translation for 2nd car*/
...
void car2(){
  ...
  glPointSize(30.0);
  glBegin(GL_POINTS);
  glVertex3f(3.1,0.3,1.3);
  glVertex3f(3.1,0.3,1.5);
  glEnd();
  glPointSize(200.0);
  ...
  /* top of cube*/
  //************************FRONT BODY****************************************
  float r1=1.0, g1=0.0, b1=0.53;
glColor3f(r1, g1, b1);
  glVertex3f(1.2, 0.4, 1.6);
  glVertex3f(1.6, 0.5, 1.6);
  glVertex3f(1.6, 0.5, 1.2);
  glVertex3f(1.2, 0.4, 1.2);

  /* bottom of cube*/
 
  glVertex3f(1.2, 0.2, 1.6);
  glVertex3f(1.6, 0.2, 1.6);
  glVertex3f(1.6, 0.2, 1.2);
  ...
  glVertex3f( 1.2, 0.4, 1.2);
//****************************************************************************
  glVertex3f(1.7, 0.65, 1.6);
  glVertex3f(1.7, 0.65, 1.2);
  glVertex3f(2.7, 0.65, 1.2);        //top cover
  glVertex3f(2.7, 0.65, 1.6);
//***************************back guard******************************
  glColor3f(r1,g1,b1);            /* Set The Color To Blue*/
  glVertex3f(2.8, 0.5, 1.6);
  glVertex3f(2.8, 0.5, 1.2);
  glVertex3f(3.1, 0.4, 1.2);
  glVertex3f(3.1, 0.4, 1.6);

  /* bottom of cube*/
  glVertex3f(3.1, 0.2, 1.6);
  glVertex3f(3.1, 0.2, 1.2);
  glVertex3f(2.8, 0.2, 1.6);
  glVertex3f(2.8, 0.2, 1.6);
...
//*********************ENTER WINDOW**********************************
  ...
  glVertex3f(1.77,0.63,1.2);
  glVertex3f(1.75,0.5, 1.2);        //quad front window
  glVertex3f(2.2, 0.5, 1.2);
  glVertex3f(2.22,0.63,1.2);

  glVertex3f(2.27, 0.63,1.2);
  glVertex3f(2.25, 0.5, 1.2);        //quad back window
  glVertex3f(2.65, 0.5, 1.2);
  glVertex3f(2.67, 0.63,1.2);

  glColor3f(r1,g1,b1);
  glVertex3f(1.7, 0.65,1.2);
  glVertex3f(1.7, 0.5, 1.2);       //first separation
  glVertex3f(1.75,0.5, 1.2);
  glVertex3f(1.77,0.65,1.2);

  glVertex3f(2.2, 0.65,1.2);
  glVertex3f(2.2, 0.5, 1.2);       //second separation
  glVertex3f(2.25,0.5, 1.2);
  glVertex3f(2.27,0.65,1.2);

  glVertex3f(2.65,0.65,1.2);
  glVertex3f(2.65,0.5, 1.2);     //3d separation
  glVertex3f(2.7, 0.5, 1.2);
  glVertex3f(2.7, 0.65,1.2);

  glVertex3f(1.75,0.65,1.2);
  glVertex3f(1.75,0.63,1.2);        //line strip
  glVertex3f(2.7, 0.63,1.2);
  glVertex3f(2.7, 0.65,1.2);

  glVertex3f(1.75,0.65,1.6);
  glVertex3f(1.75,0.63,1.6);        //line strip
  glVertex3f(2.7, 0.63,1.6);
  glVertex3f(2.7, 0.65,1.6);

  glColor3f(0.3, 0.3, 0.3);
  glVertex3f(1.77,0.63,1.6);
  glVertex3f(1.75,0.5, 1.6);        //quad front window
  glVertex3f(2.2, 0.5, 1.6);
  glVertex3f(2.22,0.63,1.6);

  glVertex3f(2.27,0.63,1.6);
  glVertex3f(2.25,0.5, 1.6);        //quad back window
  glVertex3f(2.65,0.5, 1.6);
  glVertex3f(2.67,0.63,1.6);

  glColor3f(r1,g1,b1);
  glVertex3f(1.7, 0.65,1.6);
  glVertex3f(1.7, 0.5, 1.6);       //first separation
  glVertex3f(1.75,0.5, 1.6);
  glVertex3f(1.77,0.65,1.6);

  glVertex3f(2.2,0.65,1.6);
  glVertex3f(2.2,0.5,1.6);       //second separation
  glVertex3f(2.25,0.5,1.6);
  glVertex3f(2.27,0.65,1.6);

  glVertex3f(2.65,0.65,1.6);
  glVertex3f(2.65,0.5, 1.6);
  glVertex3f(2.7, 0.5, 1.6);
  glVertex3f(2.7, 0.65,1.6);
  glEnd();

  //*************************************************************************************************
glBegin(GL_TRIANGLES);                /* 2nd car start drawing the cube.*/

  /* top of cube*/
  glColor3f(0.3,0.3,0.3);
  glVertex3f( 1.6, 0.5,1.6);
  glVertex3f( 1.7,0.65,1.6);       //tri front window
  glVertex3f(1.7,0.5,1.6);

  glVertex3f( 1.6, 0.5,1.2);
  glVertex3f( 1.7,0.65,1.2);       //tri front window
  glVertex3f(1.7,0.5,1.2);

  glVertex3f( 2.7, 0.65,1.2);
  glVertex3f( 2.8,0.5,1.2);       //tri back window
  glVertex3f( 2.7,0.5,1.2);

  glVertex3f(2.7, 0.65,1.6);
  glVertex3f(2.8,0.5,1.6);       //tri back window
  glVertex3f(2.7,0.5,1.6);

glEnd();
//************ 2nd Car IGNITION SYSTEM**********************************
glPushMatrix();
   glColor3f(0.7,0.7,0.7);
   glTranslatef(1.65,0.2,1.3);
...
glPushMatrix();
  glBegin(GL_LINE_STRIP);
	  ...
	  {
  glVertex3f(1.6,0.2,1.62);
  glVertex3f(1.6+(0.08*(cos(((theta+angle)*3.14)/180))),0.2+(0.08*(sin(((theta+angle)*3.14)/180))),1.62);
	  }
glEnd();
...
glBegin(GL_LINE_STRIP);
	  for(theta=0;theta<360;theta=theta+20)
	  {
  glVertex3f(1.6,0.2,1.18);
  glVertex3f(1.6+(0.08*(cos(((theta+angle)*3.14)/180))),0.2+(0.08*(sin(((theta+angle)*3.14)/180))),1.18);
	  }
glEnd();
...
for(theta=0;theta<360;theta=theta+20)
	  {
  glVertex3f(2.7,0.2,1.18);
  glVertex3f(2.7+(0.08*(cos(((theta+angle)*3.14)/180))),0.2+(0.08*(sin(((theta+angle)*3.14)/180))),1.18);
	  }
glEnd();
...
for(theta=0;theta<360;theta=theta+20)
	  {
  glVertex3f(2.7,0.2,1.62);
 glVertex3f(2.7+(0.08*(cos(((theta+angle)*3.14)/180))),0.2+(0.08*(sin(((theta+angle)*3.14)/180))),1.62);
	  }
glEnd();
  glTranslatef(1.6,0.2,1.6);
  glColor3f(0,0,0);
  ...
  glColor3f(0.3,0.3,0.3);
  glVertex3f(1.6, 0.5, 1.6);
  glVertex3f(1.6, 0.5, 1.2);        //quad front window
  glVertex3f(1.7, 0.65,1.2);
  glVertex3f(1.7, 0.65,1.6);

  glVertex3f(2.7, 0.65,1.6);
  glVertex3f(2.7, 0.65,1.2);        //quad back window
  glVertex3f(2.8, 0.5, 1.2);
  glVertex3f(2.8, 0.5, 1.6);
...
//*****************************road and surrounding development***********************************
  ...
  glColor3f(0.7,0.7,0.7);
  glVertex3f(-100, 0.1, 0);
  glVertex3f(-100, 0.1, 0.95);         //a long road
  glVertex3f(100,  0.1, 0.95);
  glVertex3f(100,  0.1, 0);

  glColor3f(1.0,0.75,0.0);
  glVertex3f(-100, 0.1, 0.95);       //a median
  glVertex3f(-100, 0.1, 1.05);
  glVertex3f(100,  0.1, 1.05);
  glVertex3f(100,  0.1, 0.95);

  glColor3f(0.7, 0.7,0.7);
  glVertex3f(-100, 0.1, 1.05);
  glVertex3f(-100, 0.1, 1.8);         //a long road
  glVertex3f(100,  0.1, 1.8);
  glVertex3f(100,  0.1, 1.05);
  ...
  glColor3f(0.117,0.56,1.0);
  glVertex3f(-100,0.1,1.8);
  glVertex3f(-100,0.1,100.5);         //a green surroundings
  glVertex3f(100,0.1,100.5);
  glVertex3f(100,0.1,1.8);
    glPopMatrix();
  }
  glEnd();
  ...
  if(wheelflag)
  {
	  ...
	  for(i=0;i<500;i+=0.2)
	  {
		  glVertex3f(-100+i,0,1.8);
		  glVertex3f(-99.9+i,0,1.8);
		  glVertex3f(-99.9+i,0.3,1.8);
		  glVertex3f(-100+i,0.3,1.8);
		  i+=0.5;
	  }
	  for(i=0;i<500;i+=0.2)
	  {
		  ...
		  glVertex3f(-99.9+i, 0.3, 0);
		  glVertex3f(-100+i, 0.3, 0);
		  i+=0.5;
	  }
	  glEnd();
	  glPopMatrix();
...
static void SpecialKeyFunc( int Key, int x, int y )
{
  ...
  case GLUT_KEY_LEFT:
    ...
    // 2nd car control keys
  case GLUT_KEY_UP:
		if(!wheelflag)
		xt2 += 0.4;
    xt -= 0.2;// for both car to move
...
void myMenu(int id)
{
	...
	if (id==5)
	{
		...
		glutPostRedisplay();
	         ...
	         glClearColor(0.1,0.1,0.1,0);
	         GLfloat fogcolour[4]={0.2,0.2,0.2,0.1};
                 glFogfv(GL_FOG_COLOR,fogcolour);              /* Define the fog colour */
	...
	GLfloat fogcolour[4]={0.2,0.2,0.1,0.7};
